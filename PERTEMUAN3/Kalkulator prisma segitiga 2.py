...
def hitung_luas():
    ...
    luas = 2 * (math.pi * Alas_segitiga * Tinggi_alas + Alas_segitiga * tinggi_prisma + math.pi * Alas_segitiga * Tinggi_alas)
...
def hitung_volume():
    ...
    volume = math.pi * Alas_segitiga * Tinggi_alas * tinggi_prisma
