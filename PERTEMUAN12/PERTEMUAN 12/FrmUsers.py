...
class FormLogin:
    ...
    def onSubmit(self, event=None):
        ...
        if C:
            ...
            self.parent.destroy()
            messagebox.showinfo("Login Berhasil", "Selamat datang!")  # Menampilkan pesan login berhasil
        else:
            messagebox.showwarning("Login Gagal", "Email atau password salah.")  # Menampilkan pesan login gagal
